...
function Hero() {
  return (
    <div className=''>
     ...
     <div className='flex flex-row'><h2 className='w-[215px] h-[49px] mt-[12px] font-[Montserrat] font-[700] text-[25px] leading-[48.76px]'>Hi, CapMav hellooo there</h2> <FaRegBell size={30} className='mt-[12px] ml-[110px]' /></div>  
